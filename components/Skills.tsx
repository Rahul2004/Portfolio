...
export default function Skills() {
  return (
    <section id="skills" className="border-b-2 border-neutral-900 px-6 md:px-12 lg:px-24 py-24 md:py-36 bg-[#F4F4F0]">
      <div className="max-w-6xl">
        <div className="border-2 border-neutral-900 bg-[#F4F4F0] p-8 md:p-12 mb-16 md:mb-24 shadow-[6px_6px_0px_#111] transition-all duration-300 ease-in-out">
          ...
          {categories.map((cat) => (
            <div key={cat.title} className="border-2 border-neutral-900 bg-[#F4F4F0] p-6 md:p-8 shadow-[6px_6px_0px_#111] hover:-translate-y-1 hover:shadow-[4px_4px_0px_#111] transition-all duration-300 ease-in-out">
              ...
              <div className="flex flex-wrap gap-2">
                {cat.items.map((item) => (
                  <span key={item} className="border-2 border-neutral-900 bg-[#F4F4F0] px-3 py-1 text-xs font-bold tracking-wide shadow-[3px_3px_0px_#111] hover:-translate-y-0.5 hover:shadow-[1px_1px_0px_#111] transition-all duration-300 ease-in-out">{item}</span>
                ))}
              </div>
            </div>
          ))}
